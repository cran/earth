...
@cp "C:/a/r/ra.old/bin/Rdll.lib" .
@cp "C:/a/r/ra.old/bin/Rblas.lib" .
...
@set path=c:\Rtools\bin;c:\Rtools\MinGW\bin;%PATH%
@gcc -DSTANDALONE -DMAIN -Wall -pedantic -Wextra -O3 -std=gnu99 -I"C:/a/r/ra.old/include" -I../src/tests ../earth.c Rdll.lib Rblas.lib -o earthmain-gcc.exe
